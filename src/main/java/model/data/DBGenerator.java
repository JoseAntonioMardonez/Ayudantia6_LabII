...
public class DBGenerator {
    ...
    public static void iniciarBD(String nombreBD) throws ClassNotFoundException {
        ...
        relacionarTabla(create,"Libro","codigo_carrera","Biblioteca");
    ...
    private static void crearTablaLibro(DSLContext create){
        create.createTableIfNotExists("Libro").column("titulo",VARCHAR(100))
    ...
    private static void crearTablaBiblioteca(DSLContext create){
        create.createTableIfNotExists("Biblioteca").column("rut",VARCHAR(50))
